...
export const getResume = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.getResume(req.user.userId, req.params.id);
...
export const updateResume = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.updateResume(req.user.userId, req.params.id, req.body);
...
export const atsCheck = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.runAtsCheck(req.user.userId, req.params.id, req.body);
...
export const exportPdf = catchAsync(async (req: Request, res: Response) => {
  ...
  const data = await resumeService.exportPdf(req.user.userId, req.params.id, format);
...
export const getHistory = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.getResumeHistory(req.user.userId, req.params.id);
...
export const restoreVersion = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.restoreVersion(req.user.userId, req.params.id, parseInt(req.params.version));
...
export const duplicateResume = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.duplicateResume(req.user.userId, req.params.id);
...
export const aiModifySection = catchAsync(async (req: Request, res: Response) => {
  const data = await resumeService.aiModifySection(req.user.userId, req.params.id, req.body);
